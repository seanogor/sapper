...
const posts = [
  ...
  {
    title: 'How did I set this up?',
    slug: 'how-can-i-get-involved',
    html: `
			<p> I used Vercel to set this domain using one fo the most recent performant UI framework, namely sapper. It leverages a lot of react patterns but has some extra secret sauce that make kit a true PWA builder`,
  },
];
